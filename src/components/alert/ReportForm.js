  ...
  return (
    <form onSubmit={handleSubmit} className={`min-h-screen bg-gray-50 
      ...
      <div className="fixed top-0 inset-x-0 bg-white dark:bg-gray-800 border-b 
        ...
        <div className="h-16 flex items-center justify-between px-4">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="p-2 text-emerald-600 dark:text-emerald-500 
      ...
      <div className="pt-16 pb-4 p-4 space-y-6">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute right-2 bottom-2 p-2 text-gray-500 
              ...
              <div className="flex-1 flex items-center gap-2">
                {['low', 'medium', 'high'].map(severity => (
                  <button
                    ...
                    className={`flex-1 px-3 py-1 rounded-lg text-sm capitalize ${
        ...
        {/* Submit Error */}
        {errors.submit && (
          <div className="p-4 bg-red-50 dark:bg-red-900/20 rounded-lg flex 
            items-start gap-3">
