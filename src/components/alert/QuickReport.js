...
const QuickReport = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-white dark:bg-gray-900 z-50">
      {/* Header */}
      <div className="fixed top-0 inset-x-0 bg-white dark:bg-gray-800 border-b 
        ...
        {step === 'photo' && (
          <div className="p-4">
            ...
            <button
              ...
              className="w-full aspect-video bg-gray-100 dark:bg-gray-800 
                rounded-xl border-2 border-dashed border-gray-300 
                dark:border-gray-700 flex flex-col items-center justify-center 
        ...
        {step === 'location' && (
          <div className="p-4">
            ...
            <button
              ...
              className="w-full p-4 bg-white dark:bg-gray-800 rounded-xl border 
                border-gray-200 dark:border-gray-700 flex items-center gap-3"
            >
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl border 
                ...
                <div className="flex items-start gap-3">
                  {report.type && (
                    <div className={`p-2 rounded-lg ${REPORT_TYPES.find(t => 
                      t.id === report.type)?.color}`}>
      ...
      {/* Footer */}
      <div className="fixed bottom-0 inset-x-0 bg-white dark:bg-gray-800 
        ...
        <button
          ...
          disabled={submitting}
          className="w-full h-12 bg-emerald-500 text-white rounded-lg 
